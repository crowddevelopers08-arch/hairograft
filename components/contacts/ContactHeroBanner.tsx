  ...
  return (
    <section className="relative flex min-h-[300px] items-center justify-center overflow-hidden sm:min-h-[360px] lg:min-h-[430px]">
      <Image
        ...
        alt="Consultation at Hair O Graft"
        fill
        priority
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1100px] px-4 py-16 text-center sm:px-6">
        ...
        <h1 className="text-[42px] font-extrabold leading-none tracking-tight text-white drop-shadow-[0_8px_28px_rgba(0,0,0,0.3)] sm:text-[58px] lg:text-[72px]">
          Contact Us
        </h1>
        ...
        <nav className="mt-6 flex items-center justify-center gap-2.5 text-[14px] font-semibold sm:text-[15px]" aria-label="Breadcrumb">
          ...
          <span className="text-[#FF555A]" aria-current="page">Contact Us</span>
        </nav>
      </div>
    </section>
  );

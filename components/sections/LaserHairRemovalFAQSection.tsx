...
const faqs = [
  {
    ...
    a: "Most patients find it well tolerated, often describing a mild snapping or warm sensation.",
  },
  {
    num: "02",
    q: "How many sessions will I need?",
    a: "Most patients need a course of multiple sessions, as hair grows in cycles. The exact number depends on your hair type, treatment area, and individual response.",
  },
  {
    num: "03",
    q: "Is laser hair removal permanent?",
    a: "Laser hair removal offers long-lasting hair reduction rather than permanent removal. Some maintenance sessions may be needed over time, and individual results vary.",
  },
  {
    num: "04",
    q: "Is there any downtime after treatment?",
    a: "Laser hair removal usually requires little to no downtime, though mild redness may occur temporarily.",
  },
  {
    num: "05",
    q: "Can laser hair removal be done on all skin types?",
    a: "Modern laser technology can treat a range of skin and hair types. A consultation helps determine the most suitable approach for you.",
  },
  {
    num: "06",
    q: "How soon will I see results?",
    a: "Hair reduction becomes more noticeable over successive sessions as treated hairs shed and regrowth slows. Individual results may vary.",
  },
];

export default function LaserHairRemovalFAQSection() {
  return (

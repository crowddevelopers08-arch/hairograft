...
const conditions = [
  { Icon: FiTrendingDown,  title: "Recent or gradual hair thinning" },
  { Icon: FiActivity,      title: "Increased hair fall or shedding" },
  { Icon: FiLayers,        title: "Reduced hair density or volume" },
  { Icon: FiGrid,          title: "Early-stage pattern hair loss" },
  { Icon: FiAlertTriangle, title: "Thinning that has not progressed to complete baldness" },
];

export default function PRPUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <p className="mt-2 sm:mt-3 mx-auto text-center text-gray-500 leading-[1.75]
          ...
          PRP may be suitable for individuals experiencing early or gradual hair thinning
          who still have active hair follicles.
        </p>
        ...
        <div className="mt-4 sm:mt-5 relative overflow-hidden
          ...
          <p className="relative z-10 text-gray-700 leading-[1.7]
            ...
            <span className="text-[#354C9C] font-semibold">PRP</span>{" "}
            is appropriate for your stage of hair loss, scalp condition, and goals. In some
            cases, PRP may be recommended alongside other treatments.
          </p>
        </div>

...
const tips = [
  ...
  "Avoiding additional UV exposure unless advised by your specialist",
  "Following a gentle scalp care routine",
  "Using only recommended products on the treated area",
  "Attending follow-up sessions as scheduled",
];

export default function UVLightRecoverySection() {
  return (
    <section
    ...
    >
      <div
        className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-6 sm:mb-7 lg:mb-8">
          ...
          <h2
            className="mt-4 font-extrabold leading-[1.1] tracking-tight text-[#363435]
                         text-[24px] sm:text-[28px] md:text-[33px] lg:text-[40px] xl:text-[48px]"
          >
            Recovery &amp; <span className="text-[#354C9C]">Aftercare</span>
          </h2>

          <p
            className="mt-3 text-gray-500 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px]"
          >
            UV light therapy typically requires little to no downtime, and most
            patients can resume daily activities soon after each session.
          </p>
        </div>

        <div className="grid lg:grid-cols-[0.92fr_1.08fr] gap-4 sm:gap-5 lg:gap-6 items-stretch">
          <div
            className="relative min-h-[240px] sm:min-h-[280px] lg:min-h-full
          ...
          <div
            className="bg-white rounded-[28px] border border-[#D8DDE8]
          ...
          >
            <div className="flex items-center gap-3 pb-3 border-b border-[#E4E8F0]">
              ...
              <p className="text-[#354C9C] font-black tracking-widest uppercase text-[11px]">
                For best results and safety, we recommend:
              </p>
            </div>
            ...
            <p className="mt-4 text-gray-500 leading-[1.65] text-[13px] sm:text-[14px] md:text-[15px]">
              Mild redness or dryness can occur after a session. Let your
              specialist know if you notice any persistent irritation.
            </p>
          </div>
        </div>
      </div>

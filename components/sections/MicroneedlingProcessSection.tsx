...
const steps = [
  {
    ...
    desc: "Assessment of your scalp condition, hair thinning, and treatment suitability.",
  },
  {
    Icon: FiClipboard,
    title: "Personalised Treatment Planning:",
    desc: "A tailored plan based on the cause of your thinning and your hair goals.",
  },
  {
    Icon: FiCrosshair,
    title: "Microneedling Procedure:",
    desc: "Controlled micro-channels are created on the scalp, with supportive topical treatments applied where recommended.",
  },
  {
    Icon: FiActivity,
    title: "Aftercare Guidance:",
    desc: "Personalised scalp and hair care is recommended to help support results.",
  },
];
...
export default function MicroneedlingProcessSection() {
  return (
    <section
      id="process"
    ...
    >
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          >
            Our <span className="text-[#354C9C]">Microneedling</span> Treatment Approach
          </h2>
          <p
            className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            Every microneedling treatment at Hair O Graft begins with a
            thorough scalp and hair assessment to understand your concerns and
            goals.
          </p>
          <div

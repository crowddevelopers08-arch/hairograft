...
const conditions = [
  { Icon: FiTrendingDown,  title: "Increased hair fall" },
  { Icon: FiActivity,      title: "Early to moderate hair thinning" },
  { Icon: FiLayers,        title: "Reduced hair density" },
  { Icon: FiGrid,          title: "Early signs of pattern hair loss" },
  { Icon: FiAlertTriangle, title: "Hair thinning following stress, illness, or hormonal changes" },
];

export default function GFCUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <p className="mt-2 sm:mt-3 mx-auto text-center text-gray-500 leading-[1.75]
          ...
          GFC may be suitable for individuals experiencing early to moderate hair thinning
        ...
        <div className="mt-4 sm:mt-5 relative overflow-hidden
          ...
          <p className="relative z-10 text-gray-700 leading-[1.7]
            ...
            <span className="text-[#354C9C] font-semibold">GFC</span>{" "}
            is appropriate for your hair condition, stage of hair loss, and goals.
            In more advanced hair loss, other treatment options may be recommended.
          </p>
        </div>

const offers = [
  {
    traditional: "Generic, non-targeted",
    uvLight: "Targeted to affected scalp areas",
  },
  {
    traditional: "No professional monitoring",
    uvLight: "Delivered under specialist supervision",
  },
  {
    traditional: "Limited help for immune-related hair loss",
    uvLight: "May support conditions like alopecia areata",
  },
  {
    traditional: "Inconsistent approach",
    uvLight: "Controlled, structured treatment protocol",
  },
];

export default function UVLightBenefitsSection() {
  return (
    <section
      id="benefits"
    ...
    >
      ...
      >
        <div className="text-center max-w-[720px] mx-auto">
          ...
          >
            Why Choose{" "}
            <span className="text-[#354C9C]">UV Light Therapy</span>
            <br className="hidden sm:block" /> Over General Home Care?
          </h2>
          <p
            className="mt-4 sm:mt-5 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            While general or home-based care offers limited help for
            immune-related hair loss, professional UV light therapy provides a
            targeted, monitored approach for suitable conditions.
          </p>
        </div>

...
const faqs = [
  {
    ...
    a: "The procedure is performed under local anaesthesia, so you should not feel pain during tooth preparation or crown fitting. Mild sensitivity or discomfort afterwards is common and usually settles within a few days.",
  },
  {
    num: "02",
    q: "How long do dental crowns last?",
    a: "Lifespan varies depending on the crown material, your bite, and how well you maintain your oral hygiene.",
  },
  {
    num: "03",
    q: "How many visits will I need?",
    a: "Most crowns are completed in one or two visits, depending on the crown type and the clinic process. Your dentist will confirm this after your examination.",
  },
  {
    num: "04",
    q: "Will the crown look natural?",
    a: "Tooth-coloured crowns are custom-made to closely match the shade and shape of your natural teeth. Your dentist will discuss the material options suited to your case.",
  },
  {
    num: "05",
    q: "How do I care for my crown?",
    a: "Care for a crowned tooth just like a natural tooth, regular brushing, flossing, and routine dental check-ups.",
  },
  {
    num: "06",
    q: "Can a crowned tooth still get decay?",
    a: "Yes. The crown itself does not decay, but the natural tooth beneath it can, especially around the edges. Good oral hygiene remains important to keep the teeth healthy.",
  },
];

export default function DentalCrownsFAQSection() {
  return (

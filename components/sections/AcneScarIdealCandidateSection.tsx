...
/* ── Benefit data ── */
const benefits = [
  { Icon: CleansingIcon,     title: "Reduced visibility of acne scars and marks" },
  { Icon: SmoothTextureIcon, title: "Smoother skin texture and refined pores" },
  { Icon: BrightnessIcon,    title: "Increased collagen production" },
  { Icon: RefreshIcon,       title: "Reduced active acne" },
  { Icon: HydrationIcon,     title: "Improved overall skin appearance" },
];

export default function AcneScarIdealCandidateSection() {
  return (
    <section className="overflow-hidden">
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          >
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Acne & Scar Removal Treatment</span>
          </h2>
          ...
          <p
            ...
            "
          >
            Professional treatment may help improve both active acne and the scars left behind,
            supporting healthier-looking skin over time.
          </p>
          ...
          >
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Results vary depending on the type of acne, scar severity, skin condition,
              and treatment performed, and multiple sessions may be recommended for
              optimal results.
            </p>
          </div>
        </div>

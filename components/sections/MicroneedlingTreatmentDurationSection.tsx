    ...
    <section style={{ background: "linear-gradient(170deg,#F7F8FC 0%,#FEFEFE 55%,#ffffff 100%)" }}>
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Treatment time may vary depending on the treatment area and
        ...
        >
          ...
          <p
            className="relative z-10 text-center text-white/90 leading-[1.75]
                        ...
                        max-w-[680px] mx-auto"
          >
            Microneedling is generally performed as an{" "}
            <span className="font-bold text-white">outpatient procedure</span>,
            allowing most patients to resume routine activities soon after
            treatment.
          </p>
        </div>
      </div>

...
const rows: { Icon: IconType; text: string }[] = [
  {
    Icon: FiInfo,
    text: "Dandruff treatment is a personalised scalp care approach designed to help manage flaking, itching, excess oil, and scalp irritation.",
  },
  {
    Icon: FiDroplet,
    text: "Dandruff can be associated with factors such as excess oil production, scalp dryness, product buildup, sensitivity, or an overgrowth of naturally occurring scalp microorganisms. Treatment is selected based on a scalp assessment to address your specific scalp condition and concerns.",
  },
  {
    Icon: FiShield,
    text: "Unlike a general hair care routine, professional dandruff treatment is guided by an evaluation of your scalp health and treatment needs.",
  },
];

export default function DandruffWhyChooseUsSection() {
  return (
    <section

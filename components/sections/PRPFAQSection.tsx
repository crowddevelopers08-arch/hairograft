...
const faqs = [
  {
    ...
    a: "Most patients tolerate it well. There may be mild discomfort during application, and comfort measures may be used when required.",
  },
  {
    num: "02",
    q: "How many sessions will I need?",
    a: "The exact number depends on your stage of hair loss and how your scalp responds, and your specialist will advise after assessment.",
  },
  {
    num: "03",
    q: "Is PRP suitable for complete baldness?",
    a: "PRP works best on follicles that are still active, so it is most suited to early-to-moderate thinning. It is generally not effective for areas of advanced or complete baldness where follicles are no longer active.",
  },
  {
    num: "04",
    q: "When will I see results?",
    a: "Changes are gradual and usually become more noticeable over a few months as the treatment course progresses. Individual results vary.",
  },
  {
    num: "05",
    q: "Are the results permanent?",
    a: "Results are not permanent. Hair loss is an ongoing process, so maintenance sessions and managing the underlying cause are usually needed to help sustain results.",
  },
  {
    num: "06",
    q: "Is there any downtime?",
    a: "PRP usually requires little to no downtime, and most patients return to their routine shortly after the session.",
  },
];

export default function PRPFAQSection() {
  return (

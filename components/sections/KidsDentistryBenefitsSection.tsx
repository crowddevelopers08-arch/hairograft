const offers = [
  {
    general: "Standard adult setting",
    kids: "Child-friendly, reassuring environment",
  },
  {
    general: "Limited focus on anxiety",
    kids: "Gentle approach to ease dental fear",
  },
  {
    general: "One routine for everyone",
    kids: "Care suited to a child's age and needs",
  },
  {
    general: "Less emphasis on habits",
    kids: "Guidance on lifelong oral habits",
  },
];

export default function KidsDentistryBenefitsSection() {
  return (
    <section
      id="benefits"
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto
        ...
        <div className="text-center max-w-[720px] mx-auto">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Why Choose a{" "}
            <span className="text-[#354C9C]">Child-Focused</span>
            <br className="hidden sm:block" />
            {" "}Dental Approach?
          </h2>
          <p className="mt-4 sm:mt-5 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            While general dental visits are designed mainly with adults in mind, kids
            dentistry adapts the experience to a child&apos;s comfort, age, and
            developmental needs.
          </p>
        </div>

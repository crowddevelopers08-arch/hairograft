...
const benefits = [
  { Icon: FiHeart, title: "Restored chewing and biting function" },
  { Icon: FiTrendingUp, title: "A natural-looking, custom-matched tooth" },
  { Icon: FiLayers, title: "No impact on healthy neighbouring teeth" },
  { Icon: FiZap, title: "Help in preserving the jawbone in the treated area" },
  { Icon: FiCheckCircle, title: "Improved comfort compared to removable options" },
  { Icon: FiSmile, title: "A more confident smile" },
];

export default function DentalImplantsIdealCandidateSection() {
  return (
    <section className="overflow-hidden">
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          >
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Dental Implants</span>
          </h2>
          ...
          >
            Dental implants aim to restore both the function and appearance of missing
            teeth, and may support better long-term oral health.
          </p>
          ...
          >
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              With proper care and regular dental check-ups, implants are designed to last
              many years. Individual results vary depending on oral health, bone condition,

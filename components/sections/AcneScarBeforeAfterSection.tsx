...
const galleryImages = [
  {
    src: "/acneone.png",
    alt: "Acne Scar Removal treatment showcase",
  },
  {
    src: "/acne2.png",
    alt: "Acne Scar Removal device close-up",
  },
  {
    src: "/acne3.png",
    alt: "Acne Scar Removal skin care visual",
  },
];

export default function AcneScarBeforeAfterSection() {
    ...
    <section className="bg-white">
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Explore real patient transformations and see how acne and scar treatment has helped
            individuals achieve smoother, clearer, and healthier-looking skin.
          </p>
        </div>

const offers = [
  {
    regular: "Surface-level action",
    hydrafacial: "Targets deeper skin layers",
  },
  {
    regular: "Limited improvement for scars",
    hydrafacial: "Stimulates collagen production",
  },
  {
    regular: "Generic, one-size-fits-all",
    hydrafacial: "Customised to your scar type",
  },
  {
    regular: "Inconsistent results",
    hydrafacial: "Structured treatment protocol",
  },
];

export default function AcneScarBenefitsSection() {
  return (
    <section
      id="benefits"
    ...
    >
      ...
      >
        <div className="text-center max-w-[720px] mx-auto">
          ...
          >
            Why Choose{" "}
            <span className="text-[#354C9C]">Professional Treatment</span>
          ...
          <p
            ...
            "
          >
            While over-the-counter products and home remedies may offer limited improvement for
            surface marks, professional treatment targets the underlying skin damage for more

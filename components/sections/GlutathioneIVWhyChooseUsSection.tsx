...
const rows = [
  {
    img: "/pone.png",
    alt: "Natural antioxidant support",
    text: "Glutathione is an antioxidant that occurs naturally in the body and plays a role in protecting cells and supporting the body's natural detoxification processes.",
  },
  {
    img: "/ptwo.png",
    alt: "Intravenous infusion treatment",
    text: "Glutathione IV delivers this antioxidant directly into the bloodstream through an intravenous infusion administered by trained professionals. It is commonly chosen by individuals looking to support overall skin health and achieve a brighter, more refreshed appearance.",
  },
  {
    img: "/pthree.png",
    alt: "Medical assessment before treatment",
    text: "A medical assessment is performed before treatment to determine suitability.",
  },
];

export default function GlutathioneIVWhyChooseUsSection() {
  return (
    <section
      className="relative overflow-hidden"
      style={{
        backgroundImage: "url('/gluwhyy.png')",
      ...
      <div className="relative z-10 flex flex-col justify-center
        ...
        <div className="w-full lg:max-w-[54%] xl:max-w-[50%]">
          <h2 className="font-extrabold leading-[1.05] tracking-tight text-[#363435]
            ...
            What is
            <br />
            <span className="text-[#354C9C]">Glutathione IV?</span>
          </h2>

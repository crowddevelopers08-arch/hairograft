...
const rows: { Icon: IconType; text: string }[] = [
  {
    Icon: FiInfo,
    text: "UV light therapy, also known as phototherapy, is a non-invasive treatment that delivers controlled doses of ultraviolet light to the scalp.",
  },
  {
    Icon: FiDroplet,
    text: "It is primarily used for certain scalp conditions, such as alopecia areata, where it may help support hair regrowth by reducing inflammation around the hair follicles. The treatment is often recommended alongside other therapies as part of a personalised treatment plan.",
  },
  {
    Icon: FiShield,
    text: "A consultation helps determine whether UV light therapy is appropriate for your condition.",
  },
];

export default function UVLightWhyChooseUsSection() {
  return (
    <section
      ...
      >
        <div className="w-full lg:max-w-[54%] xl:max-w-[50%]">
          ...
          >
            What is
            <br />
            <span className="text-[#354C9C]">UV Light Therapy for Hair?</span>
          </h2>

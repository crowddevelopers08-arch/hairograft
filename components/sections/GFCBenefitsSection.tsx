const offers = [
  {
    traditional: "Applied externally",
    gfc: "Delivered directly to the scalp",
  },
  {
    traditional: "General hair care support",
    gfc: "Personalised clinical treatment",
  },
  {
    traditional: "May not address active hair thinning",
    gfc: "Commonly recommended for hair thinning and early hair loss",
  },
  {
    traditional: "Self-managed",
    gfc: "Performed by trained professionals",
  },
];

export default function GFCBenefitsSection() {
  return (
    <section
      id="benefits"
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto
        ...
        <div className="text-center max-w-[720px] mx-auto">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Why Choose{" "}
            <span className="text-[#354C9C]">GFC</span>
            <br className="hidden sm:block" />
            {" "}as a Hair Restoration Option?
          </h2>
          <p className="mt-4 sm:mt-5 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            While shampoos, oils, and supplements may support overall hair care, GFC is a
            clinic-based treatment designed to deliver concentrated growth factors directly
            to the scalp.
          </p>
        </div>

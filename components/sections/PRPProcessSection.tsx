...
const steps = [
  {
    ...
    desc: "Assessment of your hair loss pattern, scalp condition, and suitability for PRP.",
  },
  {
    Icon: FiDroplet,
    title: "Blood Collection & PRP Preparation:",
    desc: "A small blood sample is taken and processed to separate the platelet-rich plasma.",
  },
  {
    Icon: FiActivity,
    title: "PRP Processing:",
    desc: "The blood sample is centrifuged to concentrate the platelet-rich plasma for treatment.",
  },
  {
    Icon: FiCrosshair,
    title: "Scalp Application:",
    desc: "The prepared plasma is introduced into the thinning areas of the scalp under hygienic conditions.",
  },
  {
    Icon: FiClipboard,
    title: "Aftercare Guidance:",
    desc: "Personalised scalp care and follow-up recommendations to support your results.",
  },
];
...
export default function PRPProcessSection() {
  return (
    <section
      id="process"
      ...
      <div className="max-w-[1400px] mx-auto
        ...
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Our <span className="text-[#354C9C]">PRP</span> Hair Treatment Approach
          </h2>
          <p className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Every PRP treatment at Hair O Graft begins with a thorough scalp and hair
            assessment to understand the cause and stage of your hair loss.
          </p>
        ...
        >
          <p className="text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each session is customised based on individual hair concerns and treatment objectives.
          </p>
        </div>
      </div>
    </section>

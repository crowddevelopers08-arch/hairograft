...
const benefits = [
  { Icon: FiTrendingDown, title: "A non-invasive, surgery-free approach" },
  { Icon: FiStar, title: "Targeted treatment for affected scalp areas" },
  {
    Icon: FiLayers,
    title: "Support for hair regrowth in conditions such as alopecia areata",
  },
  { Icon: FiZap, title: "Minimal downtime after each session" },
  { Icon: FiCheckCircle, title: "An option that can work alongside other treatments" },
];

export default function UVLightIdealCandidateSection() {
  return (
    <section className="overflow-hidden">
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          >
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">UV Light Therapy</span>
          </h2>
          ...
          >
            UV light therapy may support scalp health and hair regrowth in
            suitable conditions as part of a personalised treatment plan.
          </p>
          ...
          >
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Individual results vary depending on the condition, its severity,
              and how the scalp responds. A course of multiple sessions is
              usually needed. Results are not guaranteed, and some conditions may
              relapse over time, so ongoing management may be recommended.
            </p>
          </div>
        </div>

...
const faqs = [
  {
    ...
    a: "Glutathione IV is administered by trained professionals following a medical assessment. Suitability varies from person to person.",
  },
  {
    num: "02",
    q: "Does Glutathione IV lighten skin?",
    a: "Glutathione is commonly used to support a brighter and more even-looking complexion. Results vary between individuals, and the treatment is not intended to guarantee skin lightening or whitening.",
  },
  {
    num: "03",
    q: "How soon will I see results?",
    a: "Results are usually gradual rather than immediate and vary from person to person. Some individuals may require a course of sessions.",
  },
  {
    num: "04",
    q: "How many sessions will I need?",
    a: "This depends on your goals, skin, and medical advice. Your suitability and recommended approach will be discussed during your consultation.",
  },
  {
    num: "05",
    q: "Is the treatment painful?",
    a: "You may feel minor discomfort during needle insertion, but the treatment is generally well tolerated.",
  },
  {
    num: "06",
    q: "Is there any downtime?",
    a: "Glutathione IV usually requires little to no downtime.",
  },
];

export default function GlutathioneIVFAQSection() {
  return (

...
const tips = [
  ...
  "Avoiding sun exposure and tanning before and after sessions",
  "Avoiding waxing or plucking between sessions",
  "Following recommended skincare products",
  "Keeping the treated area clean and moisturised",
];

export default function LaserHairRemovalRecoverySection() {
  return (
    <section
      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-8 sm:py-9 md:py-10 lg:py-10">
        <div className="text-center max-w-[760px] mx-auto mb-6 sm:mb-7 lg:mb-8">
          ...
          <p className="mt-3 text-gray-500 leading-[1.75] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px]">
            Laser hair removal typically requires little to no downtime, and most patients can
            resume their daily activities soon after treatment. Mild redness or sensitivity in
            the treated area is usually temporary.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[0.92fr_1.08fr] gap-4 sm:gap-5 lg:gap-6 items-stretch">
          <div className="relative min-h-[240px] sm:min-h-[280px] lg:min-h-full rounded-[28px] overflow-hidden bg-white border border-[#D8DDE8] shadow-[0_8px_30px_rgba(53,76,156,0.08)]">
            <div className="relative h-full min-h-[400px] sm:min-h-[280px]">
              <Image
                src="/hairremoaval.png"
                alt="Laser hair removal aftercare"
                fill

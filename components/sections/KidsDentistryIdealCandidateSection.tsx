...
const benefits = [
  { Icon: FiSearch, title: "Early detection of dental concerns" },
  { Icon: FiHeart, title: "Support for healthy teeth and gums" },
  { Icon: FiSmile, title: "More positive, less stressful dental experiences" },
  { Icon: FiBookOpen, title: "Guidance on brushing, diet, and oral habits" },
  { Icon: FiCheckCircle, title: "A strong foundation for lifelong oral health" },
];

export default function KidsDentistryIdealCandidateSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          <h2 className="relative z-10 font-extrabold leading-[1.1] tracking-tight text-white
            ...
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Kids Dentistry</span>
          </h2>
          ...
          <p className="relative z-10 mt-4 sm:mt-5 text-white/65 leading-[1.75]
            ...
            Regular paediatric dental care may support your child&apos;s oral health and
            help build positive associations with dental visits over time.
          </p>
          ...
          <div className="relative z-10 mt-6 sm:mt-8 rounded-2xl border border-white/15
            ...
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Every child is different, and outcomes vary depending on their dental health,
              habits, and consistency of care. Regular check-ups help support healthy teeth
              as your child grows.
            </p>
          </div>
        </div>

...
const faqs = [
  {
    ...
    a: "Most patients feel only mild pressure when switching to a new aligner set, which usually eases within a day or two.",
  },
  {
    num: "02",
    q: "How long does aligner treatment take?",
    a: "Treatment length varies depending on your case. Your dentist will provide an estimated timeline after assessing your teeth.",
  },
  {
    num: "03",
    q: "Are clear aligners suitable for everyone?",
    a: "Aligners work best for mild to moderate alignment concerns. More complex cases may need alternative treatment.",
  },
  {
    num: "04",
    q: "Can I eat and drink with my aligners on?",
    a: "Aligners should be removed before eating or drinking anything other than water, then cleaned and placed back on.",
  },
  {
    num: "05",
    q: "How many hours a day do I need to wear them?",
    a: "For effective results, aligners are generally worn 20-22 hours per day and removed only for eating and cleaning.",
  },
  {
    num: "06",
    q: "Will my teeth stay straight after treatment?",
    a: "Wearing retainers as advised helps maintain your results. Without them, teeth can gradually shift back over time.",
  },
];

export default function ClearAlignersFAQSection() {
  return (

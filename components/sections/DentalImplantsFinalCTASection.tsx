...
export default function DentalImplantsFinalCTASection() {
  return (
    <section
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-10 md:px-16 py-10 sm:py-12 md:py-14">
        <div className="max-w-[660px]">
          ...
          <p className="text-white/70 leading-relaxed mb-7
            ...
            Schedule your consultation at Hair O Graft and find out whether dental
            implants are the right option for you.
          </p>

import { FiInfo, FiSmile, FiShield } from "react-icons/fi";
import type { IconType } from "react-icons";

const rows: { Icon: IconType; text: string }[] = [
  {
    Icon: FiInfo,
    text: "Kids dentistry, also known as paediatric dentistry, focuses on the oral health of infants, children, and teenagers from the first tooth through the teenage years.",
  },
  {
    Icon: FiSmile,
    text: "It covers preventive care, routine check-ups, early detection of dental issues, treatment of cavities, and guidance on building healthy oral habits. Care is delivered in a way that is suited to a child's age and comfort, helping them feel more at ease during visits.",
  },
  {
    Icon: FiShield,
    text: "Unlike general dental care, kids dentistry is centred around making each visit reassuring for the child while helping parents support good oral health at home.",
  },
];

export default function KidsDentistryWhyChooseUsSection() {
  return (
    <section
      className="relative overflow-hidden"
      style={{
        backgroundImage: "url('/dc-kids-treat.png')",
      ...
      <div className="relative z-10 flex flex-col justify-center
        ...
        <div className="w-full lg:max-w-[54%] xl:max-w-[50%]">
          ...
          <h2 className="font-extrabold leading-[1.05] tracking-tight text-[#363435]
            ...
            What is
            <br />
            <span className="text-[#354C9C]">Kids Dentistry?</span>
          </h2>

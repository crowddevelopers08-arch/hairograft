...
const tips = [
  "Avoiding hair wash for the time advised after treatment",
  "Avoiding harsh hair products for a few days",
  "Limiting strenuous activity and excessive sweating briefly",
  "Protecting the scalp from direct sun exposure",
  "Following the recommended treatment course and scalp care",
];

export default function PRPRecoverySection() {
  return (
    <section
      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[760px] mx-auto mb-6 sm:mb-7 lg:mb-8">
          ...
          <p className="mt-3 text-gray-500 leading-[1.75]
            ...
            PRP generally involves little to no downtime, although mild tenderness, redness,
            or sensitivity at the treatment area may occur temporarily.
          </p>
        </div>
          ...
          <div className="relative min-h-[240px] sm:min-h-[280px] lg:min-h-full
            ...
            <div className="relative h-full min-h-[350px] sm:min-h-[280px]">
              <Image
                ...
                alt="PRP hair treatment aftercare"
                fill

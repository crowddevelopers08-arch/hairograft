...
const steps = [
  {
    ...
    desc: "Assessment of your skin condition, scar type, and suitability for treatment.",
  },
  {
    Icon: CleanseIcon,
    title: "Personalised Treatment Planning:",
    desc: "A tailored plan based on your skin's specific needs.",
  },
  {
    Icon: HydrateIcon,
    title: "Advanced Treatment Procedures:",
    desc: "Depending on your skin condition, treatment may include chemical peels, microneedling, PRP therapy, laser treatments, subcision, or skin rejuvenation procedures.",
  },
  {
    Icon: GuideIcon,
    title: "Follow-Up & Aftercare:",
    desc: "Post-treatment guidance and skincare recommendations to support long-term improvement.",
  },
];
...
export default function AcneScarProcessSection() {
  return (
    <section
      id="process"
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2
            ...
            "
          >
            Our <span className="text-[#354C9C]">Acne & Scar Removal</span> Treatment Approach
          </h2>
          <p
            className="
            ...
            "
          >
            Every treatment at Hair O Graft begins with a thorough skin assessment to
            understand your scar type, acne severity, and skin condition.
          </p>
          <div
            className="

...
const features: { number: string; title: string; Icon: IconType }[] = [
  { number: "01", title: "Personalised scalp consultations",         Icon: FiSearch  },
  { number: "02", title: "Experienced hair and scalp professionals", Icon: FiUsers   },
  { number: "03", title: "Advanced scalp assessment technology",     Icon: FiZap     },
...
export default function DandruffIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        <p className="mx-auto text-center text-gray-600 leading-[1.8]
          ...
          At Hair O Graft, before recommending any treatment, our team conducts a detailed
          scalp assessment to identify the cause of your dandruff, evaluate scalp health,

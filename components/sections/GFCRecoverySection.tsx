...
const tips = [
  "Avoiding hair wash for the time advised by your specialist",
  "Avoiding harsh hair products for a few days",
  "Staying well hydrated",
  "Avoiding strenuous activity for the first 24 hours",
  "Following your specialist's aftercare instructions",
];

export default function GFCRecoverySection() {
  return (
    <section
      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[760px] mx-auto mb-6 sm:mb-7 lg:mb-8">
          ...
          <p className="mt-3 text-gray-500 leading-[1.75]
            ...
            GFC generally involves little to no downtime, although mild redness, tenderness,
            or swelling at the injection sites may occur temporarily.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[0.92fr_1.08fr] gap-4 sm:gap-5 lg:gap-6 items-stretch">
          ...
          <div className="relative min-h-[240px] sm:min-h-[280px] lg:min-h-full
            ...
            <div className="relative h-full min-h-[380px] sm:min-h-[280px]">
              <Image
                src="/gfcct.png"
                alt="GFC hair treatment aftercare"
                fill

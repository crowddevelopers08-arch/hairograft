...
/** 1. Oily or congested skin with enlarged pores */
function OilySkinIcon({ className }: { className?: string }) {
  return (
...
/** 2. Blackheads, whiteheads, or clogged pores */
function CloggedPoresIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
/** 3. Dull, tired, or uneven-looking skin */
function DullSkinIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
/** 4. Mild acne or acne-prone skin */
...
/** 5. Uneven skin texture or reduced radiance */
...
/* ── Card data ── */
const conditions = [
  { Icon: OilySkinIcon,      title: "Oily or congested skin with enlarged pores" },
  { Icon: CloggedPoresIcon,  title: "Blackheads, whiteheads, or clogged pores" },
  { Icon: DullSkinIcon,      title: "Dull, tired, or uneven-looking skin" },
  { Icon: AcneIcon,          title: "Mild acne or acne-prone skin" },
  { Icon: UnevenTextureIcon, title: "Uneven skin texture or reduced radiance" },
];

export default function CarbonPeelUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <p
          ...
          "
        >
          Carbon Peel may be suitable for individuals who want to improve oiliness,
          congestion, and overall skin clarity.
        </p>
        ...
        >
          ...
          >
            ...
            <span className="text-[#354C9C] font-semibold">Carbon Peel</span>{" "}

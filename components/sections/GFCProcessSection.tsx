...
const steps = [
  {
    ...
    desc: "Assessment of your hair loss pattern, scalp condition, and treatment suitability.",
  },
  {
    Icon: FiDroplet,
    title: "Blood Collection:",
    desc: "A small sample of your blood is drawn, similar to a routine blood test.",
  },
  {
    Icon: FiDisc,
    title: "Growth Factor Concentration:",
    desc: "The sample is processed to prepare a concentrate rich in growth factors.",
  },
  {
    Icon: FiCrosshair,
    title: "Scalp Injection:",
    desc: "The concentrate is injected into the targeted areas of the scalp.",
  },
  {
    Icon: FiClipboard,
    title: "Aftercare Guidance:",
    desc: "Personalised recommendations to support hair health following treatment.",
  },
];
...
export default function GFCProcessSection() {
  return (
    <section
      id="process"
      ...
      <div className="max-w-[1400px] mx-auto
        ...
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Our <span className="text-[#354C9C]">GFC</span> Treatment Approach
          </h2>
          <p className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Every GFC treatment at Hair O Graft begins with a thorough scalp and hair

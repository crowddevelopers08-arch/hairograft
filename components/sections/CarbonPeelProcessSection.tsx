...
function CarbonIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none"
      ...
      <path d="M8 15h8" strokeOpacity="0.6" />
      <path d="M10 18h4" strokeOpacity="0.4" />
    </svg>
  );
}

function LaserBeamIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v5" />
      ...
      <path d="M4 5l2 2M20 5l-2 2" strokeOpacity="0.5" />
    </svg>
  );
}
...
const steps = [
  {
    ...
    desc: "Assessment of your skin condition and treatment suitability.",
  },
  {
    Icon: CarbonIcon,
    title: "Carbon Application:",
    desc: "A thin layer of liquid carbon is applied and allowed to settle into the pores.",
  },
  {
    Icon: LaserBeamIcon,
    title: "Laser Treatment:",
    desc: "The laser targets the carbon, removing absorbed oil and impurities while gently supporting collagen.",
  },
  {
    Icon: AftercareIcon,
    title: "Aftercare Guidance:",
    desc: "Personalised skincare recommendations to help maintain skin health following treatment.",
  },
];
...
export default function CarbonPeelProcessSection() {
  return (
    <section
      id="process"
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2
            ...
            "
          >
            Our <span className="text-[#354C9C]">Carbon Peel</span> Treatment Approach
          </h2>
          <p
            className="
            ...
            "
          >
            Every Carbon Peel at Hair O Graft begins with a thorough skin assessment
            to understand your skin type, concerns, and goals.
          </p>
          <div
            className="
        ...
        >
          <p className="text-center text-white/90 leading-[1.75] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each session is customised based on individual skin concerns and treatment objectives.
          </p>
        </div>
      </div>
    </section>

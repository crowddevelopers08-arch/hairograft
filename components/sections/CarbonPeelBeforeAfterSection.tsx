...
export default function CarbonPeelBeforeAfterSection() {
    ...
    <section className="bg-white">
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Explore real patient transformations and see how Carbon Peel has helped individuals
            achieve brighter, clearer, and more refreshed-looking skin.
          </p>
        </div>

const offers = [
  {
    regular: "Antioxidant support",
    glutathione: "Support overall skin health",
  },
  {
    regular: "Brighter-looking skin",
    glutathione: "More even-looking skin tone",
  },
  {
    regular: "Refreshed appearance",
    glutathione: "Used as part of a personalised approach to skin health and wellness",
  },
  {
    regular: "Results vary between individuals",
    glutathione: "Not a guaranteed skin-whitening treatment",
  },
];

export default function GlutathioneIVBenefitsSection() {
  return (
    <section
      id="benefits"

...
const features = [
  { number: "01", title: "Personalised skin assessments",         icon: "/one.png" },
  { number: "02", title: "Experienced skincare professionals",    icon: "/two.png" },
  { number: "03", title: "Advanced laser technology",             icon: "/three.png" },
...
export default function LaserHairRemovalIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        <p className="mx-auto text-center text-gray-600 leading-[1.8]
          ...
          detailed skin and hair assessment to evaluate your skin type and treatment goals
        ...
        {/* ── Mobile: auto-scroll marquee (hidden on sm+) ── */}

...
const steps = [
  ...
  {
    Icon: CleanseIcon,
    title: "Cleansing, Exfoliation & Extraction:",
    desc: "Gentle removal of surface impurities, dead skin cells, and pore congestion.",
  },
  {
    Icon: HydrateIcon,
    title: "Hydration & Serum Infusion:",
    desc: "Delivery of hydrating and skin-supporting ingredients tailored to your skin's needs.",
  },
  {
    Icon: GuideIcon,
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2
            ...
            "
          >
            Our <span className="text-[#354C9C]">HydraFacial</span> Treatment Approach
          </h2>
          <p
            className="
            ...
            "
          >
            Every HydraFacial at Hair O Graft begins with a thorough skin assessment to

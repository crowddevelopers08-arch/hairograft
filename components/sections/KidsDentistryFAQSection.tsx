...
const faqs = [
  {
    ...
    a: "A first dental visit is often recommended when the first tooth appears.",
  },
  {
    num: "02",
    q: "Will the treatment hurt my child?",
    a: "Most routine treatments are gentle and well-tolerated. If a procedure may cause discomfort, appropriate measures are taken to keep your child comfortable.",
  },
  {
    num: "03",
    q: "How often should my child have a dental check-up?",
    a: "Many children benefit from a check-up every six months, though the ideal frequency depends on your child's dental health.",
  },
  {
    num: "04",
    q: "What if my child is scared of the dentist?",
    a: "Dental anxiety is common in children. Our approach is gentle and reassuring, and we take time to help children feel more at ease during their visit.",
  },
  {
    num: "05",
    q: "Are baby teeth really that important?",
    a: "Yes. Even though baby teeth eventually fall out, they play an important role in chewing, speech, and holding space for adult teeth, so caring for them matters.",
  },
  {
    num: "06",
    q: "How can I help prevent cavities in my child?",
    a: "Regular brushing, a low-sugar diet, and routine dental check-ups can all help reduce the risk of cavities, though no approach can guarantee complete prevention.",
  },
];

export default function KidsDentistryFAQSection() {
  return (

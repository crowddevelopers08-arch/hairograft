...
const conditions = [
  { Icon: FiCalendar, title: "Is due for their first dental visit" },
  { Icon: FiActivity, title: "Needs a routine check-up or cleaning" },
  { Icon: FiAlertCircle, title: "Has tooth pain, sensitivity, or signs of cavities" },
  { Icon: FiSmile, title: "Has habits like thumb-sucking that may affect dental development" },
  { Icon: FiShield, title: "Has experienced a dental injury or trauma" },
];

export default function KidsDentistryUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <h2 className="text-center font-extrabold leading-[1.12] tracking-tight text-[#363435]
                       text-[24px] sm:text-[28px] md:text-[33px] lg:text-[40px] xl:text-[48px]">
          Who Is
          <br />
          <span className="text-[#354C9C]">Kids Dentistry For?</span>
        </h2>

        <p className="mt-2 sm:mt-3 mx-auto text-center text-gray-500 leading-[1.75]
                      max-w-[540px] sm:max-w-[620px] lg:max-w-[680px]
                      text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
          Kids dentistry may be suitable for children at almost any stage of their early
          dental development.
        </p>
        ...
        <div className="mt-4 sm:mt-5 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
          ...
          <div className="flex-shrink-0 bg-[#354C9C] text-white font-semibold rounded-lg
            ...
            A dental visit may be helpful if your child:
          </div>
          <div className="hidden sm:flex items-center gap-1.5 flex-1 min-w-0">
            <div className="flex-1 h-px bg-[#D8DDE8]" />
            <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#354C9C]" />
        ...
        <div className="mt-3 sm:mt-4 flex flex-wrap justify-center gap-1 sm:gap-2">
          {conditions.map((cond, i) => (
            <div key={i}
              ...
              <div className="flex items-center justify-center rounded-full bg-[#F7F8FC]
                              w-11 h-11 sm:w-12 sm:h-12 md:w-14 md:h-14">
                <cond.Icon className="text-[#354C9C] w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" />
              </div>
              <p className="mt-1.5 sm:mt-2 font-bold text-[#363435] leading-snug
        ...
        {/* Bottom info box */}
        <div className="mt-4 sm:mt-5 relative overflow-hidden
          ...
          <p className="relative z-10 text-gray-700 leading-[1.7]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            A consultation with our team can help determine the right care for your
            child&apos;s age, dental health, and needs.
          </p>
        </div>

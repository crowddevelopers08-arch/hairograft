...
const benefits = [
  { Icon: FiAlertTriangle, title: "Reduced flaking and scalp buildup" },
  { Icon: FiStar,          title: "Relief from itching and irritation" },
  { Icon: FiDroplet,       title: "A cleaner, better-balanced scalp" },
  { Icon: FiZap,           title: "More comfortable, soothed scalp" },
  { Icon: FiHeart,         title: "A healthier environment that supports overall hair health" },
];

export default function DandruffIdealCandidateSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          <h2 className="relative z-10 font-extrabold leading-[1.1] tracking-tight text-white
            ...
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Dandruff Treatment</span>
          </h2>
          ...
          <p className="relative z-10 mt-4 sm:mt-5 text-white/65 leading-[1.75]
            ...
            Dandruff treatment may help improve scalp comfort and reduce visible flaking,
            supporting a healthier scalp over time.
          </p>
          ...
          <div className="relative z-10 mt-6 sm:mt-8 rounded-2xl border border-white/15
            ...
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Results vary depending on the cause and severity of dandruff, scalp condition,
              and adherence to recommended scalp care.
            </p>
          </div>
        </div>

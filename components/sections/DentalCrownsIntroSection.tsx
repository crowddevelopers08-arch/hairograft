...
const features: { number: string; title: string; Icon: IconType }[] = [
  { number: "01", title: "Expert dental consultations",        Icon: FiSearch  },
  { number: "02", title: "Experienced dental professionals",    Icon: FiUsers   },
  { number: "03", title: "Modern dental technology",            Icon: FiZap     },
...
export default function DentalCrownsIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        <p className="mx-auto text-center text-gray-600 leading-[1.8]
          ...
          At Hair O Graft, before recommending any treatment, our dental team carries out
          a detailed examination to assess the condition of the tooth, your bite, and your
          treatment goals, and to create a personalised treatment plan.
        </p>

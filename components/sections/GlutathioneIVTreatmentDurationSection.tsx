...
const durations = [
  "Usually takes approximately 30–45 minutes per session",
  "Duration varies based on individual factors",
  "A course of sessions may be recommended for ongoing support",
  "Includes an assessment before treatment",
];

export default function GlutathioneIVTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Glutathione IV is generally a convenient treatment that can be completed
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]
                        max-w-[680px] mx-auto">
            Glutathione IV is typically performed as an outpatient treatment, allowing
            most patients to{" "}
            <span className="font-bold text-white">resume routine activities</span>{" "}
            shortly afterwards.
          </p>
        </div>
      </div>

...
const durations = [
  "Usually takes around 30-90 minutes per session",
  "May require one or two visits",
  "Duration varies based on the tooth and the severity of the infection",
  "Includes an examination before treatment",
];

export default function RootCanalTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Root canal treatment can often be completed in one or two appointments,
            depending on the tooth and the extent of infection.
          </p>
        </div>
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]
                        max-w-[680px] mx-auto">
            Root canal treatment is generally performed as an outpatient procedure, but
            proper rest and care post-treatment are recommended, as the patient may feel
            dizzy and experience discomfort due to anesthesia.
          </p>
        </div>

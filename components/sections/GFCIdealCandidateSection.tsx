...
const benefits = [
  { Icon: FiHeart,        title: "Support for overall hair health" },
  { Icon: FiTrendingUp,   title: "Reduced hair shedding" },
  { Icon: FiLayers,       title: "Improved hair density" },
  { Icon: FiZap,          title: "Stronger-looking hair" },
  { Icon: FiCheckCircle,  title: "Non-surgical treatment" },
  { Icon: FiDroplet,      title: "Uses your own blood-derived growth factors" },
];

export default function GFCIdealCandidateSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          <h2 className="relative z-10 font-extrabold leading-[1.1] tracking-tight text-white
            ...
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">GFC Treatment</span>
          </h2>
          ...
          <p className="relative z-10 mt-4 sm:mt-5 text-white/65 leading-[1.75]
            ...
            GFC may help improve hair health and support natural hair growth over the course
            of sessions. It is a natural, non-surgical option for people in the earlier
            stages of hair loss.
          </p>
          ...
          <div className="relative z-10 mt-6 sm:mt-8 rounded-2xl border border-white/15
            ...
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Results vary depending on factors such as the cause of hair loss, stage of thinning,
              scalp condition, and individual response to treatment. Multiple sessions may be
              recommended based on clinical assessment.
            </p>
          </div>
        </div>

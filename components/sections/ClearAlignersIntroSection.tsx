...
export default function ClearAlignersIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        >
          ...
          <br className="hidden sm:block" /> for Clear Aligners
        </h2>
        ...
        >
          At Hair O Graft, before recommending any treatment, our dental team
          carries out a detailed assessment of your teeth, gums, and bite to
          evaluate your suitability and create a personalised treatment plan.
        </p>

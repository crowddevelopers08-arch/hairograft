...
const conditions = [
  { Icon: FiTrendingDown, title: "Mildly crowded or overlapping teeth" },
  { Icon: FiActivity, title: "Gaps or spacing between teeth" },
  { Icon: FiLayers, title: "Mild bite irregularities" },
  { Icon: FiGrid, title: "Teeth that have shifted after previous orthodontic treatment" },
  { Icon: FiAlertTriangle, title: "A preference for a removable, less visible option" },
];

export default function ClearAlignersUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          ...
          <br />
          for <span className="text-[#354C9C]">Clear Aligners?</span>
        </h2>
        ...
        >
          Clear aligners may be suitable for individuals who want a discreet
          option to improve mild to moderate alignment concerns.
        </p>
        ...
        >
          ...
          >
            ...
            clear aligners are appropriate for your needs. More complex cases
            may require alternative orthodontic treatment, which we will discuss
            honestly during your assessment.
          </p>
        </div>
      </div>
    </section>

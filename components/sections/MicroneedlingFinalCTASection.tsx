...
export default function MicroneedlingFinalCTASection() {
  return (
    <section
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-10 md:px-16 py-10 sm:py-12 md:py-14">
        <div className="max-w-[660px]">
          ...
          <p className="text-white font-semibold mb-2 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px]">
            Ready to find out whether microneedling could support your hair
            goals?
          </p>

          <p
            className="text-white/70 leading-relaxed mb-7
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] max-w-[520px]"
          >
            Schedule your consultation at Hair O Graft and take an informed
            first step in your hair-restoration journey.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            >
              ...
              <div>
                <p className="text-white/50 text-[9px] font-bold tracking-widest uppercase leading-none mb-1">
                  Call
                </p>
            ...
            <div
              className="flex items-start gap-3 bg-white/10 border border-white/20

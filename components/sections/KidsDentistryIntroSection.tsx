import { FiSearch, FiUsers, FiSmile, FiShield, FiHeart } from "react-icons/fi";
import type { IconType } from "react-icons";

const features: { number: string; title: string; Icon: IconType }[] = [
  { number: "01", title: "A gentle, child-friendly approach", Icon: FiSearch },
  { number: "02", title: "Experienced dental professionals", Icon: FiUsers },
  { number: "03", title: "A focus on comfort and easing dental anxiety", Icon: FiSmile },
  { number: "04", title: "High standards of safety and hygiene", Icon: FiShield },
  { number: "05", title: "Patient-focused, family-friendly care", Icon: FiHeart },
];
...
export default function KidsDentistryIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        <p className="mx-auto text-center text-gray-600 leading-[1.8]
          ...
          At Hair O Graft, before recommending any treatment, our team takes time to
          understand your child&apos;s dental health, comfort level, and individual needs
          to create a suitable care plan.
        </p>
        ...
        <div className="relative hidden xl:block" style={{ height: "58px" }}>
          ...
          {COL_CENTERS.map((pct) => (
            <div key={pct} className="absolute rounded-full bg-[#354C9C] border-2 border-white shadow-sm"
              style={{ left: `${pct}%`, top: "48px", width: "10px", height: "10px",

...
const conditions = [
  { Icon: FiHeart, title: "Healthy gums and good general oral health" },
  { Icon: FiActivity, title: "Adequate jawbone to support an implant or suitable for bone grafting" },
  { Icon: FiCheckCircle, title: "A preference for a fixed alternative to dentures" },
];

export default function DentalImplantsUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          ...
          <br />
          for <span className="text-[#354C9C]">Dental Implants?</span>
        </h2>
        ...
        >
          Dental implants may be suitable for individuals who have lost one or more
          teeth and want a fixed, long-lasting replacement.
        </p>
        ...
        >
          ...
          <p
            className="relative z-10 text-gray-700 leading-[1.7]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            Certain factors, such as smoking, uncontrolled diabetes, gum disease, or
            significant bone loss, can affect healing and suitability. A consultation
            with our dental specialists helps determine whether implants are appropriate
            for you or whether preparatory treatment may be needed first.
          </p>
        </div>
      </div>
    </section>

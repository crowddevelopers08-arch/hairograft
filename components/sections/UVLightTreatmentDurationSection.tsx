...
const durations = [
  "Sessions usually last only a few minutes",
  "Multiple sessions may be recommended",
  "Session frequency varies by condition",
  "Includes a personalised assessment before treatment",
];

export default function UVLightTreatmentDurationSection() {
  return (
    <section style={{ background: "linear-gradient(170deg,#F7F8FC 0%,#FEFEFE 55%,#ffffff 100%)" }}>
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Treatment time depends on your scalp condition and treatment plan.
          </p>
        </div>
        ...
        >
          ...
          <p
            className="relative z-10 text-center text-white/90 leading-[1.75]
                        ...
                        max-w-[680px] mx-auto"
          >
            UV light therapy is generally performed on an{" "}
            <span className="font-bold text-white">outpatient basis</span>,
            allowing most patients to resume their routine activities shortly
            after each session.
          </p>
        </div>
      </div>

...
const steps = [
  {
    Icon: FiSmile,
    title: "Friendly Consultation & Check-up:",
    desc: "A gentle introduction and assessment of your child's dental health.",
  },
  {
    Icon: FiSearch,
    title: "Examination & Assessment:",
    desc: "Careful evaluation of teeth, gums, and overall oral development.",
  },
  {
    Icon: FiClipboard,
    title: "Preventive or Personalised Care:",
    desc: "Depending on your child's needs, care may include routine cleaning, fluoride application, dental sealants, fillings, or other recommended treatments.",
  },
  {
    Icon: FiHeart,
    title: "Parent Guidance & Aftercare:",
    desc: "Practical advice on brushing, diet, and habits to support oral health at home.",
  },
];
...
export default function KidsDentistryProcessSection() {
  return (
    <section
      id="process"
      ...
      <div className="max-w-[1400px] mx-auto
        ...
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Our <span className="text-[#354C9C]">Kids Dentistry</span> Approach
          </h2>
          <p className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Every visit to Hair O Graft begins with a friendly, unhurried approach to
        ...
        >
          <p className="text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each visit is tailored to the child&apos;s age, comfort, and dental needs.
          </p>
        </div>
      </div>
    </section>

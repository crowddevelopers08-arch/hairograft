...
const conditions = [
  { Icon: FiTrendingDown, title: "Patchy hair loss associated with alopecia areata" },
  { Icon: FiActivity, title: "Certain inflammatory scalp conditions affecting hair" },
  { Icon: FiLayers, title: "A preference for a non-invasive, supportive treatment option" },
  { Icon: FiGrid, title: "Been advised that phototherapy may complement your existing care" },
];

export default function UVLightUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          ...
          <br />
          for <span className="text-[#354C9C]">UV Light Therapy?</span>
        </h2>
          ...
          {conditions.map((cond, i) => (
            <div
              ...
              className="flex flex-col items-center text-center
                ...
                p-3 sm:p-4
                w-[calc(50%_-_4px)] sm:w-[calc(50%_-_6px)] lg:w-[calc(25%_-_8px)]"
            >
              <div
        ...
        >
          ...
          >
            UV light therapy is generally not used for ordinary male or female
            pattern hair loss. A consultation with our specialists can help
            determine whether it is appropriate for your condition, scalp health,
            and goals.
          </p>
        </div>
      </div>

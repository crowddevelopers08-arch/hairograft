...
const galleryImages = [
  {
    src: "/glus1.png",
    alt: "Glutathione IV before and after result 1",
  },
  {
    src: "/glus.png",
    alt: "Glutathione IV before and after result 2",
  },
  {
    src: "/glu3.png",
    alt: "Glutathione IV before and after result 3",
  },
];

export default function GlutathioneIVBeforeAfterSection() {
    ...
    <section className="bg-white">
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Explore patient experiences and see how Glutathione IV has supported

...
const benefits = [
  { Icon: FiTrendingDown,  title: "Reduced hair fall and shedding" },
  { Icon: FiStar,          title: "Stronger, healthier-looking existing hair" },
  { Icon: FiLayers,        title: "Improved hair density in thinning areas" },
  { Icon: FiZap,           title: "Better scalp and follicle health" },
  { Icon: FiCheckCircle,   title: "Non-surgical approach with minimal downtime" },
  { Icon: FiDroplet,       title: "Uses your own blood-derived plasma" },
];

export default function PRPIdealCandidateSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          <h2 className="relative z-10 font-extrabold leading-[1.1] tracking-tight text-white
            ...
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">PRP Treatment</span>
          </h2>
          ...
          <p className="relative z-10 mt-4 sm:mt-5 text-white/65 leading-[1.75]
            ...
            PRP may help support hair health when used at the right stage and as part of a
            planned treatment course. Results build gradually and vary from person to person.
          </p>
          ...
          <div className="relative z-10 mt-6 sm:mt-8 rounded-2xl border border-white/15
            ...
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              PRP is not an instant or guaranteed solution, and it does not regrow hair where
              follicles are no longer active. Many patients notice gradual changes over a few
              months as the treatment course progresses.
            </p>
          </div>
        </div>

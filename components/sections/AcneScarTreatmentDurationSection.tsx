...
const durations = [
  "Based on the selected treatment",
  "Includes a personalised skin assessment",
  "Multiple sessions may be recommended",
  "Treatment plans are tailored to individual skin concerns",
];

export default function AcneScarTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Treatment time varies depending on the type and severity of acne or scarring,
            as well as the procedure recommended.
          </p>
        </div>
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]
                        max-w-[680px] mx-auto">
            Most treatments are performed on an outpatient basis, with{" "}
            <span className="font-bold text-white">recovery and downtime varying</span>{" "}

...
const durations = [
  "Usually takes around 30–60 minutes per session",
  "Includes blood collection and plasma preparation time",
  "Typically requires a course of sessions spaced a few weeks apart",
  "Maintenance sessions may be recommended over time",
];

export default function PRPTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Treatment time may vary depending on individual requirements.
          </p>
        </div>
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]
                        max-w-[680px] mx-auto">
            PRP is generally performed as an{" "}
            <span className="font-bold text-white">outpatient procedure</span>,{" "}
            allowing most patients to resume their routine activities shortly after treatment.
          </p>
        </div>

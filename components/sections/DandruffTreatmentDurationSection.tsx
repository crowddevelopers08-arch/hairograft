...
const durations = [
  "Varies based on scalp condition and the cause of dandruff",
  "Includes a personalised scalp assessment before treatment",
  "A course of sessions may be recommended for persistent dandruff",
  "Additional scalp care steps may increase treatment time",
];

export default function DandruffTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Treatment time varies depending on your scalp condition and treatment plan.
          </p>
        </div>
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        ...
                        max-w-[680px] mx-auto">
            Most patients can{" "}
            <span className="font-bold text-white">return to their normal routine</span>{" "}

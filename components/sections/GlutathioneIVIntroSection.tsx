...
const features = [
  { number: "01", title: "Medical assessment before treatment", icon: "/one.png" },
  { number: "02", title: "Trained, experienced professionals", icon: "/two.png" },
  { number: "03", title: "High standards of safety and hygiene", icon: "/three.png" },
  { number: "04", title: "Personalised treatment plans", icon: "/four.png" },
...
export default function GlutathioneIVIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        <p className="mx-auto text-center text-gray-600 leading-[1.8]
          ...
          detailed health and skin assessment to understand your concerns, review
          your suitability, and create a personalised plan.
        </p>

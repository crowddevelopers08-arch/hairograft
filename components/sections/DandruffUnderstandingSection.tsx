...
const conditions = [
  { Icon: FiAlertTriangle, title: "White or yellow flakes on the scalp or shoulders" },
  { Icon: FiActivity,      title: "A persistently itchy or irritated scalp" },
  { Icon: FiDroplet,       title: "An oily, congested, or buildup-prone scalp" },
  { Icon: FiLayers,        title: "A dry, flaky, or tight-feeling scalp" },
  { Icon: FiRefreshCw,     title: "Recurring dandruff that returns after regular shampoos" },
];

export default function DandruffUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <h2 className="text-center font-extrabold leading-[1.12] tracking-tight text-[#363435]
          ...
          <br />
          for{" "}
          <span className="text-[#354C9C]">Dandruff Treatment?</span>
        </h2>
        ...
        <p className="mt-2 sm:mt-3 mx-auto text-center text-gray-500 leading-[1.75]
          ...
          Dandruff treatment may be suitable for individuals dealing with ongoing scalp
        ...
        <div className="mt-4 sm:mt-5 relative overflow-hidden
          ...
          <p className="relative z-10 text-gray-700 leading-[1.7]
            ...
            <span className="text-[#354C9C] font-semibold">dandruff treatment</span>{" "}
            is appropriate for your scalp type, the cause of your dandruff, and your goals.
          </p>
        </div>

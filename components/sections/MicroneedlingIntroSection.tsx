...
export default function MicroneedlingIntroSection() {
  return (
    <section className="bg-gradient-to-b from-[#F7F8FC] via-[#FEFEFE] to-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        ...
        >
          ...
          <br className="hidden sm:block" /> for Microneedling
        </h2>
        ...
        >
          At Hair O Graft, before recommending any treatment, our team conducts
          a detailed scalp and hair assessment to understand your concerns,
          evaluate the cause of thinning, and create a personalised treatment
          plan.
        </p>

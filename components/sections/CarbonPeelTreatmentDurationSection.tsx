...
const durations = [
  ...
  "Includes a skin assessment",
  "Multiple sessions may be recommended",
  "Performed on an outpatient basis",
];

export default function CarbonPeelTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Treatment time varies depending on your skin concerns and treatment plan.
          </p>
        </div>
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]
                        max-w-[680px] mx-auto">
            Carbon Peel is generally performed as an outpatient procedure, allowing most patients
            to{" "}

...
const steps = [
  {
    ...
    desc: "Review of your skin concerns, health background, and treatment suitability.",
  },
  {
    Icon: CleanseIcon,
    title: "Personalised Treatment Planning:",
    desc: "A plan tailored to your goals, with realistic expectations discussed.",
  },
  {
    Icon: HydrateIcon,
    title: "IV Administration:",
    desc: "The infusion is carried out by trained professionals in a clean, clinical setting.",
  },
  {
    Icon: GuideIcon,
    title: "Aftercare Guidance:",
    desc: "Personalised recommendations to support your skin and overall results.",
  },
];
...
export default function GlutathioneProcessSection() {
  return (
    <section
      id="process"
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2
            ...
            "
          >
            Our <span className="text-[#354C9C]">Glutathione IV</span> Treatment Approach
          </h2>
          <p
            className="
            ...
            "
          >
            Every Glutathione IV treatment at Hair O Graft begins with a consultation and medical assessment to understand your skin, health, and goals.
          </p>
          <div
            className="
        ...
        >
          <p className="text-center text-white/90 leading-[1.75] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each session is customised based on individual concerns and treatment objectives.
          </p>
        </div>
      </div>
    </section>

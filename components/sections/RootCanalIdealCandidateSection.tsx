...
const benefits = [
  { Icon: FiHeart,        title: "Relief from tooth pain and discomfort" },
  { Icon: FiShield,       title: "Removal of infection from the tooth" },
  { Icon: FiCheckCircle,  title: "Preservation of your natural tooth" },
  { Icon: FiActivity,     title: "Restored ability to bite and chew normally" },
  { Icon: FiUsers,        title: "Protection of surrounding teeth and gums" },
];

export default function RootCanalIdealCandidateSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          <h2 className="relative z-10 font-extrabold leading-[1.1] tracking-tight text-white
            ...
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Root Canal Treatment</span>
          </h2>
          ...
          <p className="relative z-10 mt-4 sm:mt-5 text-white/65 leading-[1.75]
            ...
            Root canal treatment focuses on relieving pain and preserving your natural
            tooth, supporting healthier long-term oral function.
          </p>
          ...
          <div className="relative z-10 mt-6 sm:mt-8 rounded-2xl border border-white/15
            ...
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Treatment outcomes depend on the condition of the tooth and timely treatment.
              Your dentist may recommend a crown to help protect the treated tooth.
            </p>
          </div>
        </div>

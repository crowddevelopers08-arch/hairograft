...
const steps = [
  {
    Icon: FiSearch,
    title: "Scalp & Hair Assessment:",
    desc: "Evaluation of your scalp condition, hair loss pattern, and treatment suitability.",
  },
  {
    Icon: FiClipboard,
    title: "Personalised Treatment Planning:",
    desc: "A tailored plan, including a session schedule, based on your condition and goals.",
  },
  {
    Icon: FiCrosshair,
    title: "UV Light Therapy Sessions:",
    desc: "Controlled, targeted light exposure delivered under specialist supervision, with protection for the eyes and surrounding skin.",
  },
  {
    Icon: FiActivity,
    title: "Monitoring & Aftercare:",
    desc: "Tracking your response over the course and adjusting the plan as needed, with scalp care guidance.",
  },
];
...
export default function UVLightProcessSection() {
  return (
    <section
      id="process"
    ...
    >
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          >
            Our <span className="text-[#354C9C]">UV Light Therapy</span> Approach
          </h2>
          <p
            className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            Every treatment at Hair O Graft begins with a thorough scalp and
            hair assessment to understand the cause of hair loss and whether
            phototherapy is appropriate.
          </p>
          <div
                    ...
                    <>
                      ...
                      >
                        <div className="flex items-center gap-2.5 mb-3">
                          <div
                            className="flex-shrink-0 w-9 h-9 rounded-xl bg-[#F7F8FC]
              ...
              <div key={step.title} className="flex items-start gap-3 sm:gap-4 relative">
                ...
                >
                  <div className="flex items-center gap-2.5 mb-2.5">
                    <div
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#F7F8FC]
                  ...
                  <h4
                    className="font-extrabold text-[#363435]
        ...
        >
          <p
            className="text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            Each session is customised based on individual scalp concerns and

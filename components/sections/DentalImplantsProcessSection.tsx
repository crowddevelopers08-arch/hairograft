...
const steps = [
  {
    ...
    desc: "A clinical examination, dental imaging, and review of your medical history to evaluate suitability.",
  },
  {
    Icon: FiClipboard,
    title: "Personalised Treatment Planning:",
    desc: "A tailored plan, which may include preparatory steps such as bone grafting if required.",
  },
  {
    Icon: FiCrosshair,
    title: "Implant Placement:",
    desc: "The titanium implant is surgically placed into the jawbone, usually under local anaesthesia.",
  },
  {
    Icon: FiActivity,
    title: "Healing & Osseointegration:",
    desc: "A healing period allows the implant to integrate with the surrounding bone.",
  },
  {
    Icon: FiDisc,
    title: "Crown Placement:",
    desc: "A custom-made crown is fitted onto the implant to restore appearance and function.",
  },
  {
    Icon: FiCheckCircle,
    title: "Follow-Up & Aftercare:",
    desc: "Ongoing guidance and check-ups to support the long-term health of your implant.",
  },
];
...
export default function DentalImplantsProcessSection() {
  return (
    <section
      id="process"
    ...
    >
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          >
            Our <span className="text-[#354C9C]">Dental Implant</span> Treatment Approach
          </h2>
          <p
            className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            Every implant treatment at Hair O Graft begins with a thorough assessment to
            understand your oral health, bone condition, and goals.
          </p>
          <div
        ...
        >
          <p className="text-center text-white/90 leading-[1.75] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each treatment plan is customised based on individual needs and the number of

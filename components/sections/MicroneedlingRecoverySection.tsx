...
const tips = [
  "Avoiding hair washing for the period advised by your specialist",
  "Avoiding harsh hair or scalp products immediately after treatment",
  "Limiting direct sun exposure and heavy sweating for a short period",
  "Following recommended scalp and hair care products",
  "Attending sessions as scheduled in your plan",
];

export default function MicroneedlingRecoverySection() {
  return (
    <section
    ...
    >
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-6 sm:mb-7 lg:mb-8">
          ...
          >
            Microneedling typically requires little to no downtime, though mild
            redness or sensitivity on the scalp for a day or two is normal.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[0.92fr_1.08fr] gap-4 sm:gap-5 lg:gap-6 items-stretch">
          ...
          >
            <div className="relative h-full min-h-[350px] sm:min-h-[280px]">
              <Image
                src="/microneedling-treat.png"
                alt="Microneedling aftercare"
                fill

...
const durations = [
  "Usually takes 30–60 minutes per session",
  "Includes a scalp assessment",
  "Multiple sessions may be recommended",
  "Performed on an outpatient basis",
];

export default function GFCTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        ...
                        max-w-[680px] mx-auto">
            Most patients can{" "}
            <span className="font-bold text-white">return to their routine activities</span>{" "}

...
const conditions = [
  { Icon: FiAlertCircle,    title: "Persistent or throbbing tooth pain" },
  { Icon: FiThermometer,    title: "Sensitivity to hot or cold that lingers" },
  { Icon: FiActivity,       title: "A deep cavity or extensive tooth decay" },
  { Icon: FiZap,            title: "A cracked or chipped tooth" },
  // { Icon: FiAlertTriangle,  title: "Swelling or tenderness around the gums" },
  { Icon: FiDroplet,        title: "A darkened or abscessed tooth" },
];

export default function RootCanalUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <p className="mt-2 sm:mt-3 mx-auto text-center text-gray-500 leading-[1.75]
          ...
          Root canal treatment may be suitable for individuals with infection or damage
          affecting the inner pulp of a tooth.
        </p>
        ...
        <div className="mt-4 sm:mt-5 relative overflow-hidden
          ...
          <p className="relative z-10 text-gray-700 leading-[1.7]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            A consultation with our dental specialists can help determine whether{" "}
            <span className="text-[#354C9C] font-semibold">root canal treatment</span>{" "}

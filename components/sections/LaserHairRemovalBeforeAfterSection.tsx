...
const galleryImages = [
  {
    src: "/lone.png",
    alt: "Laser hair removal treatment showcase",
  },
  {
    src: "/ltwo.png",
    alt: "Laser hair removal device close-up",
  },
  {
    src: "/lthree.png",
    alt: "Laser hair removal skin care visual",
  },
];

export default function LaserHairRemovalBeforeAfterSection() {
    ...
    <section className="bg-white">
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Explore real patient transformations and see how laser hair removal has helped
            individuals achieve smoother, hair-reduced skin.
          </p>
        </div>

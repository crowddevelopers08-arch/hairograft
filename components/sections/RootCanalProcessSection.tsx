...
const steps = [
  {
    ...
    desc: "Clinical assessment and X-rays to evaluate the affected tooth and plan treatment accordingly.",
  },
  {
    Icon: FiShield,
    title: "Anaesthesia & Pulp Removal:",
    desc: "The area is numbed, and the infected or inflamed pulp is carefully removed.",
  },
  {
    Icon: FiDisc,
    title: "Cleaning, Shaping & Disinfection:",
    desc: "The inner canals are cleaned, shaped, and disinfected to remove infection.",
  },
  {
    Icon: FiLock,
    title: "Filling & Sealing:",
    desc: "The cleaned canals are filled and sealed to help prevent reinfection.",
  },
  {
    Icon: FiClipboard,
    title: "Restoration:",
    desc: "The tooth is restored with a filling or crown to protect it and restore function.",
  },
];
...
export default function RootCanalProcessSection() {
  return (
    <section
      id="process"
      ...
      <div className="max-w-[1400px] mx-auto
        ...
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Our <span className="text-[#354C9C]">Root Canal</span> Treatment Approach
          </h2>
          <p className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Every root canal at Hair O Graft begins with a thorough examination to assess
            the tooth and the extent of infection.
          </p>
        ...
        >
          <p className="text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each treatment plan is customised based on the condition of the tooth and individual needs.
          </p>
        </div>
      </div>
    </section>

...
function LaserIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none"
      ...
      <path d="M5 7h2M17 7h2" strokeOpacity="0.5" />
      <path d="M6.5 4.5l1.5 1.5M16 4.5l-1.5 1.5" strokeOpacity="0.5" />
    </svg>
  );
}

function AftercareIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 20h9" />
...
const steps = [
  {
    Icon: ConsultIcon,
    title: "Skin & Hair Analysis and Consultation:",
    desc: "Assessment of your skin type, hair type, and treatment suitability.",
  },
  {
    Icon: PrepIcon,
    title: "Preparation & Patch Testing:",
    desc: "The treatment area is prepared, and a patch test may be performed to check suitability.",
  },
  {
    Icon: LaserIcon,
    title: "Laser Treatment Session:",
    desc: "Targeted laser energy is applied to the treatment area to reduce hair growth.",
  },
  {
    Icon: AftercareIcon,
    title: "Aftercare Guidance:",
    desc: "Personalised recommendations to help care for your skin between sessions.",
  },
];
...
export default function LaserHairRemovalProcessSection() {
  return (
    <section
      id="process"
      ...
      >
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2
            ...
            "
          >
            Our <span className="text-[#354C9C]">Laser Hair Removal</span> Treatment Approach
          </h2>
          <p
            className="
            ...
            "
          >
            Every laser hair removal treatment at Hair O Graft begins with a thorough skin
            and hair assessment to understand your skin type, hair type, and goals.
          </p>
          <div
            className="
              mt-5 inline-flex items-center rounded-lg
              bg-[#354C9C] text-white font-semibold
              px-4 sm:px-5 py-2
                  ...
                  {above ? (
                    <>
                      ...
                      >
                        ...
                        <p className="text-gray-500 text-[13px] lg:text-[14px] leading-relaxed">
                          {step.desc}
                        </p>
                      </div>
                      <div className="w-[2px] bg-[#D8DDE8]" style={{ height: `${LINE_H}px` }} />
                      <div
                        className="flex-shrink-0 rounded-full bg-[#354C9C]
                          flex items-center justify-center
                          shadow-[0_4px_16px_rgba(53,76,156,0.40)] relative z-10"
        ...
        >
          <p className="text-center text-white/90 leading-[1.75] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each session is customised based on individual skin and hair concerns and treatment objectives.
          </p>
        </div>
      </div>
    </section>

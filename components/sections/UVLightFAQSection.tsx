...
const faqs = [
  {
    num: "01",
    q: "Is UV light therapy safe?",
    a: "When delivered under specialist supervision with controlled doses and protective measures, UV light therapy is generally well tolerated. Mild, temporary redness or dryness can sometimes occur.",
  },
  {
    num: "02",
    q: "Does UV light therapy regrow hair?",
    a: "It may help support regrowth in certain conditions, such as alopecia areata, by calming the immune activity affecting hair follicles. Results vary, are not guaranteed, and are not effective for all types of hair loss.",
  },
  {
    num: "03",
    q: "Is the treatment painful?",
    a: "UV light therapy is non-invasive and generally not painful. You may feel mild warmth during a session.",
  },
  {
    num: "04",
    q: "How many sessions will I need?",
    a: "This varies by condition and response. A course of multiple sessions is usually needed, and your specialist will advise after assessment.",
  },
  {
    num: "05",
    q: "Are the results permanent?",
    a: "Results vary from person to person. Some conditions can relapse, so maintenance sessions or ongoing management may be recommended.",
  },
];

export default function UVLightFAQSection() {
  return (

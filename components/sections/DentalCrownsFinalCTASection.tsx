...
export default function DentalCrownsFinalCTASection() {
  return (
    <section
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-10 md:px-16 py-10 sm:py-12 md:py-14">
        <div className="max-w-[660px]">
          ...
          <p className="text-white/70 leading-relaxed mb-7
            ...
            Schedule your dental crown consultation at Hair O Graft and take the first
            step towards a stronger, healthier smile.
          </p>

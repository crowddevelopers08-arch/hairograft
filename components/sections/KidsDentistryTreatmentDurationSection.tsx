...
const durations = [
  "Routine check-ups are usually short",
  "Time taken to help the child feel comfortable",
  "Duration varies based on the treatment needed",
  "Additional visits may be recommended for some treatments",
];

export default function KidsDentistryTreatmentDurationSection() {
  return (
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10
        ...
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          <p className="mt-4 text-gray-500 leading-[1.8]
            ...
            Visit length depends on whether it&apos;s a routine check-up or a specific treatment.
          </p>
        </div>
        ...
        >
          ...
          <p className="relative z-10 text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]
                        max-w-[680px] mx-auto">
            Most paediatric dental visits are performed on an{" "}
            <span className="font-bold text-white">outpatient basis</span>,{" "}
            allowing your child to return to normal activities afterwards.
          </p>
        </div>

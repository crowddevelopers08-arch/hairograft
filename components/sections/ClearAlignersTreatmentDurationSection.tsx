...
const durations = [
  "Based on case complexity, it commonly takes several months to over a year",
  "Each aligner set is usually worn for one to two weeks",
  "Aligners are typically worn 20-22 hours per day for effective results",
  "Includes a personalised assessment before treatment begins",
];

export default function ClearAlignersTreatmentDurationSection() {
  return (
    <section style={{ background: "linear-gradient(170deg,#F7F8FC 0%,#FEFEFE 55%,#ffffff 100%)" }}>
      ...
      >
        <div className="text-center max-w-[680px] mx-auto mb-8 sm:mb-10">
          ...
          >
            Clear aligner treatment is a gradual process, and the total duration
        ...
        >
          ...
          <p
            className="relative z-10 text-center text-white/90 leading-[1.75]
                        ...
                        max-w-[680px] mx-auto"
          >
            Your dentist will provide a clearer estimate of your treatment

const offers = [
  {
    traditional: "Temporary, surface-level action",
    prp: "Uses your own platelet growth factors",
  },
  {
    traditional: "Generic, one-size-fits-all",
    prp: "Personalised to your scalp and stage of hair loss",
  },
  {
    traditional: "Requires daily ongoing use",
    prp: "Periodic in-clinic sessions",
  },
  {
    traditional: "Limited effect on follicles",
    prp: "Supports the strength of active follicles",
  },
];

export default function PRPBenefitsSection() {
  return (
    <section
      id="benefits"
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto
        ...
        <div className="text-center max-w-[720px] mx-auto">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Why Choose{" "}
            <span className="text-[#354C9C]">PRP</span>
            <br className="hidden sm:block" />
            {" "}Over Over-the-Counter Hair Products?
          </h2>
          <p className="mt-4 sm:mt-5 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            While over-the-counter products mainly act on the surface and need continuous daily use,
            PRP works at the follicle level using plasma derived from your own blood.
          </p>
        </div>

const offers = [
  {
    traditional: "Surface cleansing",
    professional: "Scalp assessment + targeted treatment",
  },
  {
    traditional: "Temporary relief",
    professional: "Addresses the underlying scalp condition",
  },
  {
    traditional: "One-size-fits-all",
    professional: "Personalised to your scalp type",
  },
  {
    traditional: "Inconsistent results",
    professional: "Structured treatment plan",
  },
];

export default function DandruffBenefitsSection() {
  return (
    <section
      id="benefits"
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto
        ...
        <div className="text-center max-w-[720px] mx-auto">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Why Choose{" "}
            <span className="text-[#354C9C]">Professional Dandruff Treatment</span>
            <br className="hidden sm:block" />
            {" "}Over Regular Shampoos?
          </h2>
          <p className="mt-4 sm:mt-5 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            While regular anti-dandruff shampoos can offer temporary relief, professional
            treatment is guided by a scalp assessment and aims to address the cause behind the flaking.
          </p>
        </div>

...
const benefits = [
  { Icon: FiHeart, title: "A discreet, nearly invisible appearance" },
  { Icon: FiTrendingUp, title: "Removable trays for easier eating and cleaning" },
  { Icon: FiLayers, title: "A smooth, comfortable fit with no metal brackets or wires" },
  { Icon: FiZap, title: "Easier day-to-day oral hygiene" },
  { Icon: FiCheckCircle, title: "Gradual, planned tooth movement" },
  { Icon: FiDroplet, title: "An improved smile and bite alignment" },
];

export default function ClearAlignersIdealCandidateSection() {
  return (
    <section className="overflow-hidden">
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          />
          <div
            className="absolute -bottom-12 -left-12 w-40 h-40 rounded-full opacity-10 pointer-events-none"
            style={{ background: "radial-gradient(circle,#354C9C 0%,transparent 70%)" }}
          />

          <h2
            className="relative z-10 font-extrabold leading-[1.1] tracking-tight text-white
                         text-[24px] sm:text-[28px] md:text-[33px] lg:text-[40px] xl:text-[48px]"
          >
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Clear Aligners</span>
          </h2>
          ...
          <p
            className="relative z-10 mt-4 sm:mt-5 text-white/65 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]"
          >
            Clear aligners offer a comfortable, discreet way to work towards a
            straighter smile, and may help improve both appearance and oral
            function when suitable.
          </p>

          <div
            className="relative z-10 mt-6 sm:mt-8 rounded-2xl border border-white/15
                          bg-white/10 px-4 sm:px-5 py-4"
          >
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Results depend on consistent wear and the complexity of your case.
              Many patients notice gradual changes as they progress through
              their aligner sets. Individual results vary, and following your
              dentist&apos;s wear instructions closely is important for the best
              outcome.
            </p>
          </div>
        </div>
        ...
        {/* Right panel */}
        <div
          className="flex-1 flex flex-col justify-center bg-[#FEFEFE]
                        px-6 sm:px-10 md:px-12 lg:px-10 xl:px-14
                        py-10 sm:py-12 lg:py-14 xl:py-16"
        >
          <div
            className="inline-flex self-start items-center gap-2 mb-5 sm:mb-6

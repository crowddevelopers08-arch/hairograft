...
export default function UVLightFinalCTASection() {
  return (
    <section
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-10 md:px-16 py-10 sm:py-12 md:py-14">
        <div className="max-w-[660px]">
          ...
          <p className="text-white font-semibold mb-2 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px]">
            Ready to find out whether UV light therapy is right for your scalp
            and hair condition?
          </p>
          ...
          >
            Schedule your consultation at Hair O Graft and take the first step
            toward a personalised treatment plan.
          </p>

...
const benefits = [
  { Icon: FiTrendingDown, title: "Stimulation of the scalp and hair follicles" },
  { Icon: FiStar, title: "Improved absorption of topical hair treatments" },
  { Icon: FiLayers, title: "Better blood flow around the follicles" },
  { Icon: FiZap, title: "Non-surgical treatment" },
  { Icon: FiCheckCircle, title: "Can be combined with other hair restoration treatments" },
];

export default function MicroneedlingIdealCandidateSection() {
  return (
    <section className="overflow-hidden">
      <div className="flex flex-col lg:flex-row min-h-0">
        ...
        >
          ...
          >
            Benefits &amp; Results of{" "}
            <span className="text-[#FEEA1B]">Microneedling</span>
          </h2>
          ...
          >
            Microneedling may help support hair health and the wider treatment
            plan recommended for you. It is generally well-tolerated and
          ...
          >
            <p className="text-white/80 leading-[1.7] text-[13px] sm:text-[14px] md:text-[15px]">
              Results vary depending on the cause of hair thinning, scalp
              condition, and individual response to treatment. Multiple sessions
              may be recommended based on clinical assessment.
            </p>
          </div>
        </div>

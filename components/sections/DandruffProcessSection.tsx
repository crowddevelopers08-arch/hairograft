...
const steps = [
  {
    ...
    desc: "Assessment of your scalp condition, dandruff type, and treatment suitability.",
  },
  {
    Icon: FiDroplet,
    title: "Scalp Cleansing & Treatment:",
    desc: "Gentle cleansing to remove flakes, buildup, and excess oil from the scalp.",
  },
  {
    Icon: FiZap,
    title: "Targeted Scalp Care:",
    desc: "Treatment matched to the cause of your dandruff to help calm irritation and support a healthier scalp.",
  },
  {
    Icon: FiClipboard,
    title: "Aftercare & Maintenance Guidance:",
    desc: "Personalised scalp care and product recommendations to help manage dandruff at home.",
  },
];
...
export default function DandruffProcessSection() {
  return (
    <section
      id="process"
      ...
      <div className="max-w-[1400px] mx-auto
        ...
        <div className="text-center max-w-[760px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-extrabold leading-[1.1] tracking-tight text-[#363435]
            ...
            Our <span className="text-[#354C9C]">Dandruff</span> Treatment Approach
          </h2>
          <p className="mt-4 text-gray-500 leading-[1.8]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Every dandruff treatment at Hair O Graft begins with a thorough scalp assessment
            to understand your scalp type, condition, and the likely cause of your dandruff.
          </p>
        ...
        >
          <p className="text-center text-white/90 leading-[1.75]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            Each session is customised based on individual scalp concerns and treatment objectives.
          </p>
        </div>
      </div>
    </section>

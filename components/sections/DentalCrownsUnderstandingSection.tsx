...
const conditions = [
  { Icon: FiAlertTriangle, title: "A cracked, chipped, or broken tooth" },
  { Icon: FiActivity, title: "A tooth weakened by a large cavity or an old filling" },
  { Icon: FiShield, title: "A tooth that has undergone root canal treatment" },
  { Icon: FiGrid, title: "Worn-down or misshapen teeth" },
  { Icon: FiLayers, title: "A tooth being restored as part of a bridge or implant" },
];

export default function DentalCrownsUnderstandingSection() {
  return (
    <section className="bg-[#FEFEFE] overflow-hidden py-4 sm:py-6 md:py-7 lg:py-8 xl:py-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <p className="mt-2 sm:mt-3 mx-auto text-center text-gray-500 leading-[1.75]
          ...
          A dental crown may be suitable for individuals who need to restore or protect a
          damaged tooth.
        </p>
        ...
        <div className="mt-4 sm:mt-5 relative overflow-hidden
          ...
          <p className="relative z-10 text-gray-700 leading-[1.7]
                        text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]">
            A consultation with our dental team can help determine whether a{" "}
            <span className="text-[#354C9C] font-semibold">crown</span>{" "}
            is the right option for your tooth, or whether a more conservative treatment
            may be enough.
          </p>
        </div>
